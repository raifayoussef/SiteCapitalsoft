				...
				<ul class="main-menu__list">
					...
					<li class="menu-item-has-children">
						...
						<ul>
							...
							<li><a href="../Capital FINANCE">Solution 2</a></li>
							<li><a href="../Capital DISTIBUTION">Solution 3</a></li>
						</ul>
					</li>
					<li class="menu-item-has-children">
						...
						<div class="row" style="margin-top: -64px;">						
							<div class="col-md-12">
								<div class="accrodion-grp service-details__accrodion"
									...
									<h3 class="service-details__caption__title">Fonctionnalités :</h3>
						...
						<div class="sidebar">
							...
							<div class="sidebar__item sidebar__item--cta">
								<div class="sidebar__cta"
									style="background-image: url(../assets/images/solution/support.jpg)">
									<i class="sidebar__cta__icon icon-phone-ringing"></i>
									<h3 class="sidebar__cta__title">Vous avez des problèmes techniques
									Contacter nous maintenant</h3><!-- /.sidebar__cta__title -->
									<p class="sidebar__cta__text"><a href="tel:+212 5222-23999">+ 212 5222-23999</a>
									<br><a href="mailto:support@capitalsoft.ma">support@capitalsoft.ma</a></p>
									<!-- /.sidebar__cta__text -->
								</div><!-- /.sidebar__cta -->
							</div><!-- /.sidebar__item -->
							<div class="sidebar__item sidebar__item--btn">
								<a href="#" class="thm-btn sidebar__btn"><span>Téléchargez nos dépliants</span></a>
							</div><!-- /.sidebar__item -->
						</div><!-- /.sidebar -->
					</div><!-- /.col-lg-4 -->
				</div><!-- /.row -->
