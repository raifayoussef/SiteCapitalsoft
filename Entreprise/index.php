	...
	<div class="page-wrapper">
							...
							<div class="about-four__meta">
								<div class="about-four__author">
									...
									<div class="about-four__author__content">
										...
										<div class="about-four__author__designation">CEO Capital Soft</div>
				...
				<div class="row gutter-y-60">
					<div class="col-lg-12">
						<div class="testimonials-two__content">
							<div class="section-title ">
								<p class="section-title__text">Notre histoire</p><!-- /.section-title__text -->
		...
		<section class="section-padding--bottom section-padding--top service-one">
			<div class="container-fluid">
				<div class="section-title ">
					<p class="section-title__text">Nos Valeurs</p><!-- /.section-title__text -->
					<!-- /.section-title__title -->
				</div><!-- /.section-title -->
				<!-- /.row -->
				<div class="row gutter-y-30" style="justify-content: center;">
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="service-card-two gray-bg">
							<h3 class="service-card-two__title">Expertise</h3>
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="service-card-two gray-bg">
							<h3 class="service-card-two__title">Performance</h3>
							<!-- /.service-card-two__title -->
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="service-card-two gray-bg">
							<h3 class="service-card-two__title">Qualité</h3>
							<!-- /.service-card-two__title -->
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="service-card-two gray-bg">
							<h3 class="service-card-two__title">Disponibilité</h3>
							<!-- /.service-card-two__title -->
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="service-card-two gray-bg">
							<h3 class="service-card-two__title">Proximité</h3>
							<!-- /.service-card-two__title -->
