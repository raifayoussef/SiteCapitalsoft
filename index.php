		...
		<div class="row gutter-y-30 service-details__box-wrapper" style="padding: 50px;">
			...
			<div class="col-md-3 col-sm-12">
				<div class="service-details__box">
					<i class="service-details__box__icon"><img src="assets/images/partenaire/rms.png" alt="" style="height:90px;width:auto"></i>
					<!-- /.service-details__box__content -->
				</div><!-- /.service-details__box -->
			</div><!-- /.col-md-6 col-sm-12 -->
			<div class="col-md-3 col-sm-12">
				<div class="service-details__box">
					<i class="service-details__box__icon"><img src="assets/images/clients/HPS.png" alt="" style="height:90px;width:auto"></i>
					<!-- /.service-details__box__content -->
				</div><!-- /.service-details__box -->
			</div><!-- /.col-md-6 col-sm-12 -->
			<div class="col-md-3 col-sm-12">
				<div class="service-details__box" style="background:black">
					<i class="service-details__box__icon"><img src="assets/images/partenaire/medie.png" alt="" style="height:90px;width:auto"></i>
					<!-- /.service-details__box__content -->
				</div><!-- /.service-details__box -->
			</div><!-- /.col-md-6 col-sm-12 -->
			<div class="col-md-3 col-sm-12">
				<div class="service-details__box">
					<i class="service-details__box__icon"><img src="assets/images/partenaire/USG.png" alt="" style="height:90px;width:auto"></i>
					<!-- /.service-details__box__content -->
				</div><!-- /.service-details__box -->
			</div><!-- /.col-md-6 col-sm-12 -->
