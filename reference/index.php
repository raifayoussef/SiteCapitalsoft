...
<head>
	...
	<style>
		...
		#Home {
			background-color: #a2ff8600;
		}

		#News {
			background-color: #17298300;
		}
		...
		.flex-container {
			...
			/* Adjust as needed: space-around, space-between, etc. */
			align-items: flex-start;
			/* Adjust as needed: flex-start, center, flex-end, etc. */
		}
...
<body class="custom-cursor">
	...
	<div class="page-wrapper">
		...
		<div class="page-header">
			<div class="page-header__bg" style="background-image: url(../assets/images/background/grand.jpg);"></div>
			<!-- /.page-header__bg -->
			<div class="container">
	...
	<div class="mobile-nav__wrapper">
		...
		<div class="mobile-nav__content">
			...
			<div class="logo-box">
				<a href="index.html" aria-label="logo image"><img src="../assets/images/logo-light.png" width="98" height="33" alt="Cretech"></a>
			</div>
			<!-- /.logo-box -->
